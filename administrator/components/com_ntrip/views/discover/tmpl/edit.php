...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		if (task == 'discover.cancel' || document.formvalidator.isValid(document.id('discover-form'))) {
			Joomla.submitform(task, document.getElementById('discover-form'));
		}
	}
</script>

<form action="<?php echo JRoute::_('index.php?option=com_ntrip&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="discover-form" class="form-validate" enctype="multipart/form-data">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_NTRIP_NEW_DISCOVER') : JText::sprintf('COM_NTRIP_DISCOVER_DETAILS', $this->item->id); ?></legend>
...
<div class="width-40 fltrt">
	<?php echo JHtml::_('sliders.start', 'discover-sliders-'.$this->item->id, array('useCookie'=>1)); ?>

 ...
 * @since		1.5
 */
class NtripViewShopping extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_NTRIP_MANAGER_SHOPPING_NEW') : JText::_('COM_NTRIP_MANAGER_SHOPPING_EDIT'), 'shoppings.png');

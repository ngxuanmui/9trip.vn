	...
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<ul class="adminformlist">
				...
				<li><?php echo $this->form->getLabel('relax_class'); ?>
				    <?php echo $this->form->getInput('relax_class'); ?>
				</li>
...
<div class="width-40 fltrt">
	<?php echo JHtml::_('sliders.start', 'relax-sliders-'.$this->item->id, array('useCookie'=>1)); ?>

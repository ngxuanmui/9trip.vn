...
/**
 * Methods supporting a list of discover records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_ntrip
 * @since		1.6
 */
class NtripModelDiscovers extends JModelList
{
	/**
	 * Constructor.
	 *

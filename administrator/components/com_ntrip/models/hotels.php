...
/**
 * Methods supporting a list of hotel records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_ntrip
 * @since		1.6
 */
class NtripModelHotels extends JModelList
{
	/**
	 * Constructor.
	 *

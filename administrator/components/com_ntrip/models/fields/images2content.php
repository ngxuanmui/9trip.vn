...
class JFormFieldImages2Content extends JFormFieldList
{
	...
	{
		$rel = $this->element['rel'] ? $this->element['rel'] : 'description';
		...
		$html .= '<p id="f1_upload_process"><span>Loading...</span><img src="'.JURI::root().'loca/ajaxupload/loader.gif" /><br/></p>
                     <p id="f1_upload_form" align="center">
                        ...
                        <input type="button" name="submitBtn" class="submitBtn" class="sbtn" value="Upload" />
                     </p>
...
function stopUpload(success, msg, src){
      ...
      document.getElementById('f1_upload_form').innerHTML = result + '<input name="myfile" type="file" size="30" /><input type="button" name="submitBtn" class="submitBtn" class="sbtn" value="Upload" />';

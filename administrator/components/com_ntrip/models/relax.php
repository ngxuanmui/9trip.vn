 ...
 * @since       1.6
 */
class NtripModelRelax extends JModelAdmin
{
	/**
	 * @var    string  The prefix to use with controller messages.
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_NTRIP_RELAX';
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Relax', $prefix = 'NtripTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_ntrip.relax', 'relax', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_ntrip.edit.relax.data', array());
...
//			NtripHelper::updateImages($id, $currentImages, 'relaxes');
			...
			// update content
			$content = NtripHelper::copyFilesOnSave($data['description'], 'relaxes', $id);

 ...
 * @since       1.6
 */
class NtripModelDiscover extends JModelAdmin
{
	/**
	 * @var    string  The prefix to use with controller messages.
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_NTRIP_DISCOVER';
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Discover', $prefix = 'NtripTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_ntrip.edit.discover.data', array());
	...
	public function save($data)
	{
	    if (parent::save($data))
	    {
			...
			// Upload thumb
			$item = $this->getItem();
			$data['images'] = NtripHelper::uploadImages('images', $item, $delImage, 'discovers');
			...
			// update content
			$content = NtripHelper::copyFilesOnSave($data['description'], 'discovers', $id);

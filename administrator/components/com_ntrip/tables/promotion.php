 ...
 * @since		1.5
 */
class NtripTablePromotion extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_promotions', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Promotion', 'NtripTable');
			...
			$table = JTable::getInstance('Promotion', 'NtripTable');

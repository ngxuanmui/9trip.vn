 ...
 * @since		1.5
 */
class NtripTableFix_Info extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_fix_infos', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		if (empty($this->id))
		{
			...
			$table = JTable::getInstance('Fix_Info', 'NtripTable');
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Fix_Info', 'NtripTable');

 ...
 * @since		1.5
 */
class NtripTableQuestion extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_questions', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Question', 'NtripTable');
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		$table = JTable::getInstance('Question', 'QuestionsTable');

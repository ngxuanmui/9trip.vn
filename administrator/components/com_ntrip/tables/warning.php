 ...
 * @since		1.5
 */
class NtripTableWarning extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_warnings', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Warning', 'NtripTable');
			...
			$table = JTable::getInstance('Warning', 'NtripTable');

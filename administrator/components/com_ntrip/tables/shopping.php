 ...
 * @since		1.5
 */
class NtripTableShopping extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_shoppings', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Shopping', 'NtripTable');
			...
			$table = JTable::getInstance('Shopping', 'NtripTable');
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		$table = JTable::getInstance('Shopping', 'ShoppingsTable');

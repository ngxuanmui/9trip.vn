 ...
 * @since		1.5
 */
class NtripTableComment extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_comments', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Comment', 'NtripTable');
			...
			$table = JTable::getInstance('Comment', 'NtripTable');

 ...
 * @since		1.5
 */
class NtripTableService extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__ntrip_services', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Service', 'NtripTable');
			...
			$table = JTable::getInstance('Service', 'NtripTable');

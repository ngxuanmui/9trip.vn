...
/**
 * Methods supporting a list of promotion records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_ntrip
 * @since		1.6
 */
class NtripModelUser_Man_Promotions extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__ntrip_promotions').' AS a');

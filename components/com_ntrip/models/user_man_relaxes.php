...
/**
 * Methods supporting a list of relaxs records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_ntrip
 * @since		1.6
 */
class NtripModelUser_Man_Relaxes extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__ntrip_relaxes').' AS a');
...
//		$query->join('LEFT', $db->quoteName('#__languages').' AS l ON l.lang_code = a.language');
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'User_Man_Relax', $prefix = 'NtripTable', $config = array())
	{

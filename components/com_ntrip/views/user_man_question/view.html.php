 ...
 * @since		1.5
 */
class NtripViewUser_Man_Question extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_NTRIP_MANAGER_QUESTION_NEW') : JText::_('COM_NTRIP_MANAGER_QUESTION_EDIT'), 'questions.png');

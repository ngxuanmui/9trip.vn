...
?>
<form action="<?php echo JRoute::_('index.php?option=com_ntrip&view=albums'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php endif; ?>
					<?php if ($canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_ntrip&task=album.edit&id='.(int) $item->id); ?>">
				...
				<td class="center">
					<a href="<?php echo JRoute::_('index.php?option=com_ntrip&view=comments&type=album&item_id='.$item->id); ?>">
						<?php echo JText::_('COM_NTRIP_HEADING_COMMENT'); ?>
					</a>
				</td>
				<td class="center">

			...
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<?php if ($item->checked_out) : ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'shoppings.', true); ?>
					<?php endif; ?>
				...
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->state, $i, 'shoppings.', false, 'cb', $item->publish_up, $item->publish_down); ?>
				</td>
				<td class="center">

...
<form action="<?php echo JRoute::_('index.php?option=com_ntrip&task=user_man_hotel.save&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="hotel-form" class="form-validate" enctype="multipart/form-data">

	...
	<div class="margin-bottom5">
		...
		<div class="tabs">
			<ul class="tab-categories">
				...
				<li class="active"><a href="<?php echo JRoute::_('index.php?option=com_ntrip&view=user_man_shoppings'); ?>">Mua sắm</a></li>
				...
				<table class="list-user-hotels" cellpadding="10" border="0" cellspacing="0" width="98%">
					...
					<tr class="row<?php echo $i % 2; ?>">
						<td>
							...
							<a href="<?php echo JRoute::_('index.php?option=com_ntrip&task=user_man_shopping.edit&id='.(int) $item->id); ?>">
					...
					<tr>
						<td colspan="5">
							<!--<button type="button" onclick="javascript:location.href='<?php echo JRoute::_('index.php?option=com_ntrip&task=user_man_shopping.add', false); ?>'">Add new</button>-->
						</td>
					</tr>
				</table>
				<!--<div>

		...
		<div class="item-container">
			...
			<div class="social-info">
				...
				<div class="social-button fltrgt">
					...
					<a class="icons add-image <?php if (!$userGuest) echo 'modal'; ?>" id="btn-add-image" login="<?php echo ($userGuest) ? 'no' : 'yes'; ?>" href="<?php echo JRoute::_('index.php?option=com_ntrip&view=upload_image&tmpl=component&id='.$item->id.'&type=services'); ?>" rel="{handler: 'iframe', size: {x: 440, y: 460}, onClose: function() {}}"></a>
			...
			<div class="info">
				...
				<div class="content">
					...
					<p><b>Xếp hạng:</b> Dịch vụ ở Quảng Ninh</p>

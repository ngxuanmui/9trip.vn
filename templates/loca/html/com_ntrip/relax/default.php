...
<div id="left-content">
	<div class="margin-bottom5">
		...
		<div class="item-container">
			...
			<div class="social-info">
				...
				<div class="social-button fltrgt">
					...
					<a class="icons add-image <?php if (!$userGuest) echo 'modal'; ?>" id="btn-add-image" login="<?php echo ($userGuest) ? 'no' : 'yes'; ?>" href="<?php echo JRoute::_('index.php?option=com_ntrip&view=upload_image&tmpl=component&id='.$item->id.'&type=relaxes'); ?>" rel="{handler: 'iframe', size: {x: 440, y: 460}, onClose: function() {}}"></a>
			...
			<div class="info">
				...
				<div class="content">
					...
					<p><b>Xếp hạng:</b> Giải trí ở Quảng Ninh</p>
		...
		<?php Ntrip_CommentHelper::showForm($item->id, 'relaxes'); ?>

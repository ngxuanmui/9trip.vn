	...
	<div class="margin-bottom5">
		...
		<div class="tabs">
			<ul class="tab-categories">
				...
				<li class="active"><a href="<?php echo JRoute::_('index.php?option=com_ntrip&view=user_man_relaxes'); ?>">Giải trí</a></li>
			</ul>
			<div class="clr"></div>
		</div>
		<div class="list-hotels-container" style="padding: 10px 0; margin-top: 0">
			<form action="<?php echo JRoute::_('index.php?option=com_ntrip&view=relaxs'); ?>" method="post" name="adminForm" id="adminForm">
				<table class="list-user-hotels" cellpadding="10" border="0" cellspacing="0" width="98%">
					...
					<tr>
						<td colspan="5">
							<!--<button type="button" onclick="javascript:location.href='<?php echo JRoute::_('index.php?option=com_ntrip&task=user_man_relax.add', false); ?>'">Add new</button>-->
						</td>
					</tr>					
				</table>				
				<!--<div>

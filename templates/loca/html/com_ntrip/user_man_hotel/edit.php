...
<script type="text/javascript">
	...
	{
		if (task == 'user_man_hotel.cancel' || document.formvalidator.isValid(document.id('user_man_hotel-form'))) {
			Joomla.submitform(task, document.getElementById('user_man_hotel-form'));
		}
	}
</script>

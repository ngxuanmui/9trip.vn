...
<div id="left-content">
	<div class="margin-bottom5">
		<div class="intro-list-main-item">
			<label>Dịch vụ <?php echo $this->items[0]->category_title; ?> </label>
	...
	<?php echo NtripFrontHelper::itemsMenu('services'); ?>
	...
	<div class="clr"></div>
	<div class="list-main-tab-container">
		...
		<div class="list-main-items-content">
			<ul>
				...
				<li>
					<a class="title" href="<?php echo JRoute::_('index.php?option=com_ntrip&view=service&id=' . $item->id . ':' . $item->alias, false); ?>">
						<?php echo $item->name; ?>
					</a>
					...
					<div class="content">
						...
						<span class="fltlft full-star-over-yellow"><span class="star-yellow<?php echo str_replace('.', '-', $item->service_class); ?>"></span></span>
